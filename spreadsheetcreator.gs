...
var titles = ["sleep", "brush_teeth", "toilet", "shower", "breakfast", "lunch", "dinner",
  "break", "running", "reading", "weight_training", "journaling",
  "reflection", "house_cleaning", "studying", 
  "active_recall", "active_practise", "programming", "cooking", "planning", 
  "errands", "general_tasking", "work", "travelling", "relax", 
  "transition", "games", "shows"]
...
function createDateSheet(date){
  ...
  "reflection", "house_cleaning", "studying", 
  "active_recall", "active_practise", "programming", "cooking", "planning", 
  "errands", "general_tasking", "gatherings", "work", "travelling", "relax", 
  "transition", "games", "shows"]
